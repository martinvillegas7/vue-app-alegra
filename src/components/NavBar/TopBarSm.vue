<template>
  ...
  <header ref="topBar"
    class="flex flex-col bg-transparent text-lg p-5 lg:hidden sticky top-0 left-0 right-0 h-0  transition-all duration-500 ease-in-out pointer-events-none overflow-hidden opacity-0">
    ...
    <div class="flex flex-col mt-5 justify-between h-full">
      <div class="flex flex-col gap-4">
        <router-link to="/" class="inline-flex items-center transition-colors- px-2 h-full hover:text-custom-30aba9">
          Inicio
        </router-link>
        <hr>
        <router-link to="/" class="inline-flex items-center transition-colors- px-2 h-full hover:text-custom-30aba9">
        ...
        <div class="solutions flex flex-col gap-2">
          <router-link to="/"
            ...
            <img src="../../assets/alegra-new-brand-icon-accounting-minus-padding.svg" alt=""
              class="h-7 object-cover mr-2">
            Facturación
          </router-link>
          <router-link to="/"
            class="inline-flex items-center transition-colors- px-2 h-full hover:text-custom-30aba9 text-gray-700">
